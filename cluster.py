"""
Author      : Yi-Chieh Wu and Brynn Arborico
Class       : HMC CS 158
Date        : 2017 Feb 27
...
class Cluster(object) :
    ...
    def centroid(self) :
        ...
        center = np.mean(attributes_array, axis=0)
        
        centroid = Point(name, cluster_label, center)
        return centroid
...
class ClusterSet(object):
    ...
    def centroids(self) :
        ...
        # part 2b: implement
        centroids = [c.centroid() for c in self.members]
        return centroids
    ...
    def medoids(self) :
        ...
        # part 2b: implement
        medoids = [c.medoid() for c in self.members]
        return medoids
